...
ag= int(input(' Enter "0" for display in 2D or "1" for display in 3D '))
...
fenetre = Tk()
fenetre.title("Vaibhav's Rubiks's Cube")
...
phrase = Label(fond, text="Vaibhav's Rubik's Cube", fg='black' , bg ='#E4E4E4' , font= "Helvetica 36 bold")
phrase.pack()
fond.create_window(800, 590, window=phrase)
